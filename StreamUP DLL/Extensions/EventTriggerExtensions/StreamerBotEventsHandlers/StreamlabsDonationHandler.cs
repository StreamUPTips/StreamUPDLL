...
namespace StreamUP
{
    public class StreamlabsDonationHandler : IEventHandler
    {
        public TriggerData HandleEvent(IDictionary<string, object> sbArgs, StreamUpLib SUP)
        {
            ...
            decimal inputAmount = SUP.GetValueOrDefault<decimal>(sbArgs, "donationAmount", -1);
            string inputCurrencyCode = SUP.GetValueOrDefault<string>(sbArgs, "donationCurrency", "No arg 'currency' found");
