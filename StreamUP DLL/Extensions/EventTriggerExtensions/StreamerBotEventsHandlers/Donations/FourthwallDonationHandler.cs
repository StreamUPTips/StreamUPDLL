...
namespace StreamUP
{
    public class FourthwallDonationHandler : IEventHandler
    {
        public TriggerData HandleEvent(IDictionary<string, object> sbArgs, StreamUpLib SUP)
        {
            ...
            string inputCurrencyCode = SUP.GetValueOrDefault<string>(sbArgs, "currency", "No arg 'fw.currency' found");
            ...
            triggerData.Message = SUP.GetValueOrDefault<string>(sbArgs, "message", "No arg 'fw.message' found");
            triggerData.User = SUP.GetValueOrDefault<string>(sbArgs, "username", "No arg 'fw.username' found");
