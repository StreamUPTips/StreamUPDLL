...
namespace StreamUP {
    ...
    public static class ProductSettingsUIExtensions {
        ...
        public static bool SUExecuteSettings(this IInlineInvokeProxy CPH, string productName, List<StreamUpSetting> streamUpSettings, string introText)
        {
            ...
            CPH.AddButtonControls(toTable: settingsTable, withParent: settingsForm, atIndex: streamUpSettings.Count + 1, streamUpSettings);
        ...
        private static List<string> GetSBActions(this IInlineInvokeProxy CPH)
        {
            ClientWebSocket ws = new ClientWebSocket();
            var sbActions = new List<string>();

            var wsuri = args["websocketURI"].ToString();
            try {
        ...
        private static void AddButtonControls(this IInlineInvokeProxy CPH, TableLayoutPanel toTable, Form withParent, int atIndex, List<StreamUpSetting> streamUpSettings)
        {
            ...
            resetButton.Click += (sender, e) => {
                ...
                if (result == DialogResult.Yes) {
                    ...
                    withParent.Close();
                    CPH.RunAction(args["actionName"].ToString(), false);
                }
            };
